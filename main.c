...
unsigned char *data = stbi_load("растровый.png",&width,&height,&cnt,0);
...
TButton btn[] = {
    {"Spritelist", {50, 250, 200, 250, 200, 310, 50, 310}, FALSE},
    {"Remove", {50, 350, 200, 350, 200, 410, 50, 410}, FALSE},
    {"Exit", {50, 450, 200, 450, 200, 510, 50, 510}, FALSE}
};
